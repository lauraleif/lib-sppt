...
INSTALLING 
Copy the Bepress2Portico folder with the config.txt and Bpress.exe.

RUNNING
Open config.txt and edit the journal, volume, issue, date, publisher, email, depositor, urlbase, and batchid information. 
This will tell the program which issue to retrieve from Bepress. The file should
...
Note: Email, depositor, and batchid are used for the CrossRef export. 
